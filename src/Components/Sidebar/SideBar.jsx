...
const SideBar = () => {
  ...
  return (
    <aside className="hidden md:block z-40 bg-white dark:bg-black border-r border-gray-200 dark:border-gray-700
      sticky top-0 h-screen w-64">
      <div className="px-3 py-4 fixed">
        {token && (
          <nav className="flex flex-col gap-2 text-base font-medium p-5 text-white">
                <NavLink
                  to="/authUser"
