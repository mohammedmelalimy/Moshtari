    ...
    <div className="bg-gray-100 dark:bg-black dark:text-white min-h-screen">
      ...
      <div className="w-full">
        ...
        <div className="mb-6 ">
          ...
          <a
            href="#next-section"
            className="absolute animate-bounce left-1/2 transform -translate-x-1/2 top-[75%] md:top-[90%] text-gray-700 dark:text-gray-300 opacity-75 hover:opacity-100 transition-opacity duration-300"
          >
